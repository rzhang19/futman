...
class PlayerTest {
	static Player player1 = new Player("test", "player", "", LocalDate.of(1999, 12, 1), Player.Position.ATT, 80, 85, 65,
			75, 70, 55);
	...
	void test_getPositionEnum() {
		assert player1.getPositionEnum() == Player.Position.ATT;
		assert player2.getPositionEnum() == Player.Position.NONE;
		assert player3.getPositionEnum() == Player.Position.NONE;
	}
